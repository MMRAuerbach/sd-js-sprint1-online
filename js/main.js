...
// } else {
//     console.log(`NO ALERT :: studentnumber = ${studentNumber} and name is ${studentName}`);
// }

// //Function to show an alert, message as parameter that wil show up
